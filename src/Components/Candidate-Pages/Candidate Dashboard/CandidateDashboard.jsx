          ...
          <div className="post-jobs-want">
            <div className="row">
              <div className="col-6 mb-3 p-0">
                <Link to="/profile">
                  <button className="card col-btn">
                    <p>
                      <i class="fa-solid fa-pen"></i>Edit Your Profile
                    </p>
                  </button>
                </Link>
              </div>
              <div className="col-6 mb-3 p-0">
                <Link to="/profile-preview">
                  <button className="card col-btn">
                    <p>
                      <i class="fa-solid fa-building"></i>Profile Preview
                    </p>
                  </button>
                </Link>
              </div>
            ...
            <Link to="/jobs">
              <button className="card row-btn">
                <p>
                  <i className="fa-solid fa-plus mr-2 "></i>Want to apply for Jobs
                </p>
              </button>
            </Link>
          </div>
